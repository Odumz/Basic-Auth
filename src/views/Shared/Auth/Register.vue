          ...
          <b-form class="pr-4">
            <div v-if="step == 1">
              <p class="col-lg-9 text-break lead font-weight-bold pb-3">
                Enter your business name and email to get started
              </p>
              <b-form-group
            ...
            <div v-if="step == 2">
              ...
              <b-form-group id="input_phone" label-for="phone" class="my-2">
                <b-form-input
                  id="phone"
                  v-model="data.phone"
                  type="phone"
              ...
              <b-form-group id="input_category" label-for="category" class="">
                <b-form-select
